...
public class Reactor<T> implements Server<T> {
            ...
            while (!Thread.currentThread().isInterrupted()) {
                ...
                for (SelectionKey key : selector.selectedKeys()) {
                    ...
                    if (!key.isValid()) {
                        ...
                        handleAccept(serverSock, selector, stomp);
                    } else {
                        handleReadWrite(key);
                    }
                }
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector , StompConnection<T> stomp) throws IOException {
